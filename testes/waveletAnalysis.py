...
# Bibliotecas para o Psycopg 2 / Postgres
...
# READ THE DATA
sst = np.loadtxt('/home/vinicius/Documentos/dados.dat')  # input SST time series // usar select no banco para pegar os dados
...
# Loop para salvar 5 copias da imagem
#for i in range(5):
#	plt.savefig(str(i) + '.png')



plt.savefig('/home/vinicius/Documentos/14.png')

# Salvando uma imagens com fundo transparante
# plt.savefig('/home/vinicius/Documentos/7.png',transparent = True)



# SQL para inserir a imagem no banco
sql = "INSERT INTO objetos VALUES('arquivo: 14.png',lo_import('/home/vinicius/Documentos/14.png'))"

cur.execute(sql)

subprocess.call(["ls","/home/vinicius/Documentos/"])

# Executando bash dentro do Python
#subprocess.call(["rm","/home/vinicius/Documentos/7.png"])
...
'''
#--- Plot global wavelet spectrumse
