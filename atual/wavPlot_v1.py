...
cur.execute("SELECT precipitac FROM trmm where lat = -22.125000000000000 and lon = -51.375000000000000 and datatrmm >= '1998/01/01' and datatrmm <= '1999/01/01' order by datatrmm limit 360")
rows = cur.fetchall()
for row in rows:
