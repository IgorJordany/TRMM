...
for i in range(19006,41553):
	...
	for j in range(1,41553):
		...
		if Acod_ponto != Bcod_ponto and Adata != Bdata:
			...
			aux=(distWavelet, distBruto, Bcod_ponto, Bdata)
			lista.append(aux)
	lista.sort()
	lista6primeiros=[]
